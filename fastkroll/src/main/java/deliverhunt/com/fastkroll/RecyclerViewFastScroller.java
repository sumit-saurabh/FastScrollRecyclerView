package deliverhunt.com.fastkroll;
...
public class RecyclerViewFastScroller extends LinearLayout
{
            ...
            recyclerView.getViewTreeObserver().addOnPreDrawListener(
                new ViewTreeObserver.OnPreDrawListener()
                {
                    ...
                    public boolean onPreDraw()
                    {
                        ...
                        if (bubble == null || handle.isSelected())
                            return true;
                        final int verticalScrollOffset = recyclerView
                            .computeVerticalScrollOffset();
                        final int verticalScrollRange = recyclerView
    ...
    private void setRecyclerViewPosition(float y)
    {
        if (recyclerView != null)
        {
            ...
            final int targetPos =
                getValueInRange(0, itemCount - 1, (int) (proportion * (float) itemCount));
